...
$(".sound__soundActions .soundActions__medium .sc-button-group-medium").eq(0).append('<a class="sc-button sc-button-medium sc-button-responsive" target="_blank" href="http://sc-downloader.com/download.php?url='+encodeURIComponent(url)+'&amp;utm_source=ffaddon" title="Download '+title+'" id="scd_usamaejaz">Download</a>');
$(".soundActions .sc-button-group-medium").eq(0).append('<a class="sc-button sc-button-medium sc-button-responsive" target="_blank" href="http://sc-downloader.com/download.php?url='+encodeURIComponent(url)+'&amp;utm_source=ffaddon" title="Download '+title+'" id="scd_usamaejaz">Download</a>');
...
$(this).find('.soundActions .sc-button-group-small').eq(0).append('<a class="sc-button sc-button-small sc-button-icon sc-button-responsive" target="_blank" href="http://sc-downloader.com/download.php?url='+encodeURIComponent('http://soundcloud.com'+url)+'&amp;utm_source=ffaddon" title="Download '+title+'" id="scd_usamaejaz1">Download</a>');
...
$(".soundList__item > .activity").each(function(){
	if(!$(this).find(".sound").is(".playlist")){
		...
		if($(this).find("#scd_usamaejaz").length==0){
			$(this).find('.soundActions .sc-button-group-small').eq(0).append('<a class="sc-button sc-button-small sc-button-responsive" target="_blank" href="http://sc-downloader.com/download.php?url='+encodeURIComponent('http://soundcloud.com'+url)+'&amp;utm_source=ffaddon" title="Download '+title+'" id="scd_usamaejaz">Download</a>');
...
$(".userStream").find(".soundList__item > .userStreamItem").each(function(){
	if(!$(this).find(".sound").is(".playlist")){
		...
		url=$(this).find(".soundTitle__title").eq(0).attr("href");
		if($(this).find("#scd_usamaejaz1").length==0){
			$(this).find('.soundActions .sc-button-group-small').eq(0).append('<a class="sc-button sc-button-small sc-button-responsive" target="_blank" href="http://sc-downloader.com/download.php?url='+encodeURIComponent('http://soundcloud.com'+url)+'&amp;utm_source=ffaddon" title="Download '+title+'" id="scd_usamaejaz1">Download</a>');
		}
}
